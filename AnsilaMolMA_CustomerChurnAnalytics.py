...
# **College:** Viswajyothi College of Engineering and Technology, Muvattupuzha  
# **Domain:** Data Analytics with Artificial Intelligence  
# **Dataset:** Official IBM Telco Customer Churn Benchmark Dataset (`WA_Fn-UseC_-Telco-Customer-Churn.csv`)  
...
# ## 16. Conclusion & Submission Sign-off
# - **Project Title:** Telco Customer Churn Analytics and Predictive Modeling Using AI
# - **Student Name:** Ansila Mol M A
# - **College:** Viswajyothi College of Engineering and Technology
# - **Program:** IBM SkillsBuild Academic Internship (Data Analytics with AI) in collaboration with BharatCares and AICTE
# - **Achieved ROC-AUC Score:** **0.844** (Random Forest & Gradient Boosting)
