...
├── AnsilaMolMA_CustomerChurnAnalytics.ipynb  # Primary complete executed Jupyter Notebook
├── AnsilaMolMA_CustomerChurnAnalytics.py     # Standalone Python script version
├── AnsilaMolMA_ProjectReport.docx            # Full academic project documentation report
├── requirements.txt                          # Python library dependencies
├── README.md                                 # Project documentation & summary
├── WA_Fn-UseC_-Telco-Customer-Churn.csv      # Official IBM Telco Churn dataset
└── figures/                                  # High-resolution generated charts
    ├── churn_distribution.png
    ├── demographics_churn.png
    ├── contract_payment_churn.png
    ├── services_churn.png
    ├── charges_tenure_dist.png
...
```bash
cd C:\Users\VICTUS\.gemini\antigravity\scratch\ibm-skillsbuild-data-analytics
```

### 2. Install Required Dependencies
Ensure Python 3.10 or newer is installed, then install all project dependencies:
```bash
...
```bash
jupyter notebook AnsilaMolMA_CustomerChurnAnalytics.ipynb
```
*Alternatively, open `AnsilaMolMA_CustomerChurnAnalytics.ipynb` directly in VS Code.*

### 4. Run the Standalone Python Script (Optional)
To execute the pipeline directly in the terminal:
```bash
python AnsilaMolMA_CustomerChurnAnalytics.py
```

---

## 👤 Author Information
- **Student Name:** Ansila Mol M A
- **Degree:** Bachelor of Technology in Computer Science and Engineering
- **Institution:** Viswajyothi College of Engineering and Technology, Muvattupuzha
- **Email:** ansilamolma17@gmail.com
- **GitHub:** [AnsilaMolMA](https://github.com/AnsilaMolMA)
- **LinkedIn:** [ansila-mol-ma](https://linkedin.com/in/ansila-mol-ma)

---

## 📜 Acknowledgments
Special thanks to **IBM SkillsBuild**, **BharatCares (CSRBOX Foundation)**, and **AICTE** for offering this academic internship program and providing the curriculum, resources, and benchmark datasets.
